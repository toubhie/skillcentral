...
class Home extends CI_Controller {
    ...
    public function payment(){
        ...
        //echo $this->session->userdata('is_certificate_payment'); die;
        ...
        $page_data['is_certificate_payment'] = $is_certificate_payment;
        $page_data['course_id'] = $this->session->userdata('course_id');
