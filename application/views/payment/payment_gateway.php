...
<?php
	...
	if($this->session->userdata('is_certificate_payment') == 1){
		$is_certificate_payment = true;
	} else{
		$is_certificate_payment = false;
	}

	$back_url = $is_certificate_payment == true ? 'home/my_courses' : 'home/shopping_cart';
?>
		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-12">
					...
					<a href="<?php echo site_url($back_url); ?>" class="close-btn-light float-right"><i class="fa fa-times"></i></a>
				</div>
			</div>
		</div>
	</div>
