...
class Email_model extends CI_Model {
	...
	public function free_course_purchase_notification($student_id = "", $payment_method = "", $amount_paid = "", $course_id = ""){
	...
	public function course_purchase_notification_admin($course_id = "", $student_full_name = "", $student_email = "", $amount = ""){
		...
		$subject = "Student Enrolment";
		$admin_msg = "<h2>Course Title: ".$course_details['title']."</h2>";
		$admin_msg .= "<p><b><span style='color: #2ec75e;'>Course Price</b>: ".currency($amount)."</span></p>";
		$admin_msg .= "<p><b>Course Owner (Instructor) Details:</b></p>";
		$admin_msg .= "<p><b>Name:</b> ".$instructor_details['first_name']." ".$instructor_details['last_name']."</p>";
		$admin_msg .= "<p><b>Email:</b> ".$instructor_details['email']."</p>";
		$admin_msg .= "<hr style='opacity: .4;'>";
		$admin_msg .= "<p><b>Student Information:-</b></p>";
		$admin_msg .= "<p><b>Name:</b> ".$student_full_name."</p>";
		$admin_msg .= "<p><b>Email:</b> ".$student_email."</p>";
		$admin_msg .= "<p>Best Regards,</p>";
		$admin_msg .= "<p>Skill Central NG</p>";
	...
	public function course_purchase_notification_instructor($course_id = "",$student_full_name = "", $student_email = ""){
		...
		$instructor_first_name = $this->user_model->get_user($course_details['user_id'])->row('first_name');
		$instructor_last_name = $this->user_model->get_user($course_details['user_id'])->row('last_name');

		$subject = "Student Enrolment";
		$instructor_msg = "<h2>Course Title: ".$course_details['title']."</h2>";
		$instructor_msg .= "<p>Dear " .$instructor_first_name. " " .$instructor_last_name. ",</p>";
		$instructor_msg .= "<p>A student just enrolled for one of your courses titled: <b>".$course_details['title']."</b>.</p>";
		$instructor_msg .= "<p><b>Student Information:-</b></p>";
		$instructor_msg .= "<p><b>Name:</b> ".$student_full_name."</p>";
		$instructor_msg .= "<p><b>Email:</b> ".$student_email."</p>";
		$instructor_msg .= "<p>Best Regards,</p>";
		$instructor_msg .= "<p>Skill Central NG</p>";
	...
	public function course_purchase_notification_student($course_id = "", $student_id = ""){
		...
		$student_first_name = $this->user_model->get_user($student_id)->row('first_name');
		$student_last_name = $this->user_model->get_user($student_id)->row('last_name');

		$instructor_details = $this->user_model->get_user($course_details['user_id'])->row_array();

		$subject = "Course Purchase";
		$student_msg = "<h2>Course Title: ".$course_details['title']."</h2>";
		$student_msg .= "<p>Dear " .$student_first_name. " " .$student_last_name. ",</p>";
		$student_msg .= "<p>Your enrolment for the <b>".$course_details['title']."</b> course was successful.</p>";
		$student_msg .= "<hr style='opacity: .4;'>";
		$student_msg .= "<p><b>Course owner (Instructor) Details:</b></p>";
		$student_msg .= "<p><b>Name:</b> ".$instructor_details['first_name']." ".$instructor_details['last_name']."</b></p>";
		$student_msg .= "<p><b>Email:</b> ".$instructor_details['email']."</b></p>";
		$student_msg .= "<p>Goodluck!</p>";
		$student_msg .= "<p>From Skill Central NG</p>";
